...
fn get_global_adjustments_from_json(
    ...
    GlobalAdjustments {
        ...
        lens_fstop: get_val("effects", "lensFStop", SCALES.lens_fstop, Some(50.0)),
...
// Lens Blur
        ...
        lens_fstop: adj.get("lensFStop").and_then(|v| v.as_f64()).unwrap_or(50.0) as f32 / SCALES.lens_fstop,
